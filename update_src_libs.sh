...
webpath="https://niebert.github.io"
...
for filename in  "fontawesome-webfont.eot" "fontawesome-webfont.svg" "fontawesome-webfont.ttf" "fontawesome-webfont.woff" "fontawesome-webfont.woff2" "FontAwesome.otf"
do
  ...
  then
  	...
  	echo "   Check file '$file' - not found - try to download."
    wget $websource/fonts/$filename  -O $file
		sleep $sleeptime
  fi
done
echo "---------------------------------------------------"
